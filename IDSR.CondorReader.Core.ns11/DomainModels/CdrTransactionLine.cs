...
namespace IDSR.CondorReader.Core.ns11.DomainModels
{
    public class CdrTransactionLine
    {
        public CdrTransactionLine(IDataRecord r)
        {
            ...
            ProductID              = r.ToDecimal ( 2);// decimal   float DEFAULT 0,
            ...
            Multiplier             = r.ToDecimal (22);// decimal   float DEFAULT 1,
            ...
            Shift                  = r.ToInt     (31);// int       integer NOT NULL DEFAULT 0,
            ...
            LayawayNumber          = r.ToInt_    (50);// int?      integer,
            pVatable               = r.ToInt     (51);// int       integer DEFAULT 0,
            pVatPercent            = r.ToInt     (52);// int       integer DEFAULT 0,
            ...
            TaxID                  = r.ToInt     (69);// int       integer DEFAULT 0,
        ...
        public decimal     ProductID              { get; }// float DEFAULT 0,
        ...
        public decimal     Multiplier             { get; }// float DEFAULT 1,
