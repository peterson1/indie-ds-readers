...
namespace IDSR.CondorReader.Core.ns11.DomainModels
{
    public class CdrTransactionHeader
    {
        public CdrTransactionHeader(IDataRecord r)
        {
            ...
            Shift                  = r.ToInt     (12);//integer NOT NULL DEFAULT 0,
